...
class Advertisements14Admin(admin.ModelAdmin):
    list_display = ['id', 'title', 'description', 'price', 'auction', 'connection', 'created_date', 'updated_date', 'get_html_image'] # отвечает за то, какие толбцы таблицы будут показаны в админке
